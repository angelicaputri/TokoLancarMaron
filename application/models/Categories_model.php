...
class Categories_model extends CI_Model
{
	...
	*
	*/
	public function get_categories($id='',$limit='', $start='', $order_method='asc')
	{
		$this->db->select(
			$this->categories_table.".id, ".
			$this->categories_table.".code, ".
			$this->categories_table.".name, ".
			$this->categories_table.".sales, ".
			$this->categories_table.".telepon, ".
	...
	*
	*/
	public function get_categories_by_code($code='',$limit='', $start='', $order_method='asc')
	{
		$this->db->select(
			$this->categories_table.".id, ".
			$this->categories_table.".code, ".
