...
function calc(){
one = document.autoSumForm.awal.value;
two = document.autoSumForm.masuk.value; 
three = document.autoSumForm.keluar.value; 
document.autoSumForm.akhir.value = (one * 1) + (two * 1) - (three * 1);}
function stopCalc(){
