...
<div class="login-box">
	<div class="login-logo">
		<a href="<?php echo base_url(); ?>"><b>Toko Lancar Maron</b></a>
	</div>
	<!-- /.login-logo -->
	<div class="login-box-body">
		<p class="login-box-msg">Login untuk memulai manajemen barang</p>
		<?php echo $message; ?>
		...
		<div class="form-group text-center">
			<a href="<?php echo base_url('auth/forgot_password') ?>">Lupa Password</a><br>
		</div>
